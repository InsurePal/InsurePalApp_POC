...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(SupportFriends.App_Start.FontAwesomeBundleConfig), "RegisterBundles")]

namespace SupportFriends.App_Start
{
	public class FontAwesomeBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new StyleBundle("~/Content/fabundle").Include("~/Content/fontawesome/font-awesome.css"));
		}
	}
}